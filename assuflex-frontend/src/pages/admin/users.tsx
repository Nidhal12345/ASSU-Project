...
export function AdminUsers() {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (user: User) => new Date(user.dateInscription).toLocaleDateString("fr-FR"),
    },
    {
      header: "Actions",
      accessorKey: "id" as keyof User,
        ...
        <div className="flex gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem>Gestionnaires</DropdownMenuItem>
              <DropdownMenuItem>Intégrateurs</DropdownMenuItem>
              ...
              <DropdownMenuItem>Suspendus</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </div>
