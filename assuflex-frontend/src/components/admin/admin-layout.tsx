...
export function AdminLayout() {
  ...
  const getPageTitle = () => {
    ...
    if (path.startsWith("/admin/settings")) return "Paramètres administrateur"
    if (path.startsWith("/admin/analytics")) return "Analyses système"
    if (path.startsWith("/admin/activity")) return "Activité système"
