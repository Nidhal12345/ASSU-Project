        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-8 md:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link to={"/nos-garanties"} className="text-gray-400 hover:text-white transition-colors">Pack Jeune actif / Étudiant</Link>
              </li>
              <li>
                <Link to={"/nos-garanties"} className="text-gray-400 hover:text-white transition-colors">Pack Famille</Link>
              </li>
              <li>
                <Link to={"/nos-garanties"} className="text-gray-400 hover:text-white transition-colors">Pack Senior / Retraité</Link>
              </li>
              <li>
                <Link to={"/nos-garanties"} className="text-gray-400 hover:text-white transition-colors">Pack Travailleur Indépendant</Link>
              </li>
              <li>
                <Link to={"/nos-garanties"} className="text-gray-400 hover:text-white transition-colors">Pack Entreprise / TPE</Link>
              </li>
            </ul>
          </div>
