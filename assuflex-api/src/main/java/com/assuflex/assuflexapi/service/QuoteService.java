...
public class QuoteService {
    ...
    private InsuranceOffersResponse.InsuranceOffer createInsuranceOffer(
        ...
        // Determine user profile to get the right name and features
        ...
        // Generate profile-based offer name
        ...
        return new InsuranceOffersResponse.InsuranceOffer(
                ...
                profileBasedName,  // Using profile-based name instead of offre.getNom()
                offre.getAssureur(),
                totalTariff,
                coverage,
                generateOfferFeatures(offre, profile)  // Updated to include profile
        );
    }
    ...
    private UserProfile determineUserProfile(int age, String profession) {
        ...
        // Senior (60 ans et +) OR profession is "retraité"
        ...
        // Adulte actif (31–59 ans)
        if (age >= ADULT_MIN_AGE && age <= ADULT_MAX_AGE) {
            return UserProfile.ADULT;
        }

        // This should never happen with the age ranges above, but kept as safety
        return UserProfile.INVALID;
    }
    ...
    private List<String> generateOfferFeatures(Offre offre, UserProfile profile) {
        ...
        // Standard features for all profiles
